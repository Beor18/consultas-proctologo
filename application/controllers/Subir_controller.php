   ...
   public function subir(){
      ...
      if (!empty($_FILES['userfile']['name']))
        ...
        $buscar = array(
            ...
            'aspirinas_no' => $this->input->post('aspirinas_no'),
            ...
            'bulto_mayor_un' => $this->input->post('bulto_mayor_un'),
            'bulto_duele_si' => $this->input->post('bulto_duele_si'),
            'bulto_duele_no' => $this->input->post('bulto_duele_no'),
            'bulto_azulado_si' => $this->input->post('bulto_azulado_si'),
            'bulto_azulado_no' => $this->input->post('bulto_azulado_no'),
            'picazon_si' => $this->input->post('picazon_si'),
            'picazon_no' => $this->input->post('picazon_no'),
            'picazon_alrededor_ano_si' => $this->input->post('picazon_alrededor_ano_si'),
            'picazon_alrededor_ano_no' => $this->input->post('picazon_alrededor_ano_no'),
            'verrugas_ano_si' => $this->input->post('verrugas_ano_si'),
            'verrugas_ano_no' => $this->input->post('verrugas_ano_no'),
            'tratamiento_previo_consulta' => $this->input->post('tratamiento_previo_consulta'),
            'extra_cuestionario' => $this->input->post('extra_cuestionario'),
            'fotos' => $userfile,
            'fotosdos' => $userfile2,
            'fotostres' => $userfile3
            );
